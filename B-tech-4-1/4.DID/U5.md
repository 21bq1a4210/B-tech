...
* Before starting to write any documentation, it is **crucial to understand the intended users and how they will use the documentation**. This user-centred approach ensures the documentation meets the needs of its audience.
* Questions to consider include: 
    * Who is the intended audience? 
    * What are their expectations? 
    * How will they use the documentation (one-time use or repeated reference)?
    * What is their reading level, native language, and comfort level with technology?
* Answers to these questions inform the **design, language, and content** of the documentation.

**Content Organisation and Writing Style:**

* **Instructional objectives should be clear**, guiding both the writer and the reader. 
* **Content sequencing should be logical**, progressing from known concepts to more complex ones, avoiding forward references, and presenting information in manageable chunks.
* **Sufficient examples and sample sessions** enhance understanding and provide practical context.
* In today's online world, **documentation is often published in multiple formats and locations**. 
    * The mantra "write once, publish many places" reflects this reality.
    * Tools like **Acrolinx** can assist in managing multi-platform publishing.
* **Dividing content into topics and subtopics** aids navigation and comprehension.
* Organisation can be based on various factors, such as time, sequence, tasks, user roles, information type, or commonly asked questions. 
* The **DITA standard** promotes reusable "chunks" of content categorised as concept, task, and reference, allowing for flexible publishing across different platforms.

**Writing for the Web:**

* **Writing for the web demands a different approach than traditional writing**. 
* Factors like **small screen sizes on mobile devices and users' short attention spans** require concise and impactful writing.
* **The inverted pyramid style**, where the most important information comes first, is well-suited for online content as users may not scroll through lengthy text. 
* **Understanding users' reading patterns, such as the F-shaped pattern, is crucial**. 
    * **Key information should be placed at the beginning of paragraphs and along the left side of the page**, where users' eyes tend to focus.
* **Leslie O'Flahavan's "bite, snack, meal" approach** caters to varying levels of reader engagement.
    * A bite is the headline or main point, a snack provides more detail or a summary, and a meal represents the full article.

**Design Maxims for Web Writing:**

* The sources recommend the following guidelines when writing for the web:
    * Break text into short sections with clear headings.
    * Start with the key message.
    * Write short sentences and paragraphs.
    * Use lists and tables (noting that tables may not be optimal for mobile devices).
    * Write meaningful links (avoiding generic phrases like "click here").
    * Use illustrations to enhance content.

**The Value of Good Content:**

*  The sources consistently emphasise the **importance of well-written, user-focused documentation**. 
    * High-quality documentation is essential for customer success and should be prioritised as part of the development process. 
    * User manuals and online help should be created **early in the design cycle** to aid both developers and users.
    * Continuous improvement of documentation is vital, with user feedback playing a significant role in refinement.
* **Technical writers play a critical role in shaping effective documentation**.
    * Their skills in understanding both the technical aspects and the user's needs ensure clarity and usability.
    * Early involvement of technical writers in the development process leads to better product specifications and more seamless integration of documentation.

**The sources focus extensively on the principles and practices of creating effective documentation, particularly in the context of online content. While they do not provide specific instructions on "shaping the content," they offer a comprehensive framework for understanding user needs, content organisation, writing styles, and design considerations, all of which contribute to shaping documentation that effectively supports users.** 
